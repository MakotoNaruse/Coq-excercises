...
Proof.
  intros l. induction l as [ | n l' IHl' ].
  - simpl. reflexivity.
  - simpl. rewrite -> rev_app_distr, IHl'. simpl. reflexivity. Qed.
...
Proof.
  ...
  - simpl. reflexivity.
  - simpl. destruct n as [| n']. rewrite -> IHl1'.
...
Proof.
  intros l. induction l as [ | n l' IHl' ]. 
  - simpl. reflexivity.
  - simpl. rewrite -> IHl', same_nat. reflexivity. Qed.
(** [] *)
