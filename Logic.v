...
Fact not_implies_our_not : forall (P:Prop),
  ~ P -> (forall (Q:Prop), P -> Q).
Proof.
  intros P contra Q HP. destruct contra. apply HP. Qed.
(** [] *)
...
Theorem contrapositive : forall (P Q : Prop),
  (P -> Q) -> (~Q -> ~P).
Proof.
  intros P Q HPQ HNQ. unfold not. 
  unfold not in HNQ. intros HP. apply HNQ.
  apply HPQ. apply HP.
Qed.
(** [] *)
...
Theorem iff_trans : forall P Q R : Prop,
  (P <-> Q) -> (Q <-> R) -> (P <-> R).
Proof.
  intros P Q R. intros [HPQ HQP] [HQR HRQ]. split.
...
Proof.
  ...
  - intros [[x1 HPx] | [x2 HQx]].
    + exists x1. left. apply HPx.
    + exists x2. right. apply HQx.
Qed.
(** [] *)
...
Proof.
 intros A l l' a. induction l as [| l1 l2 IHl].
  - simpl. split.
...
Proof.
  ...
  - intros y. induction y as [| y' IHy'].
    + simpl. split.
      * intros H. discriminate H.
      * intros []. reflexivity.
    + simpl. split.
      * intros []. unfold not. intros H. discriminate H.
  ...
  - intros y. induction y as [|y' IHy'].
    + simpl. split.
      ...
      * intros H. reflexivity.
    + simpl. split.
      * intros H1. unfold not. intros H2. injection H2 as H3.
         apply IHx' in H1. rewrite H3 in H1. destruct H1. reflexivity.
      * intros H1. apply IHx'. unfold not. intros H2.
        rewrite H2 in H1. destruct H1. reflexivity.
Qed.
(** [] *)
